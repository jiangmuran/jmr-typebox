  ...
  <template v-if="show">
    ...
    <div class="ctx" :style="{ left: x + 'px', top: y + 'px' }">
      <template v-if="aiEnabled">
        <div class="ctx-label ctx-ai-label"><svg style="width:12px;height:12px;margin-right:5px;vertical-align:-2px" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.5c.4 4.2 1.8 5.6 6 6-4.2.4-5.6 1.8-6 6-.4-4.2-1.8-5.6-6-6 4.2-.4 5.6-1.8 6-6z"/></svg>{{ t('ai.menu') }}</div>
