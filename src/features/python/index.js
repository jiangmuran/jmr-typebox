...
export default {
  ...
  i18n: {
    en: {
      ...
      'py.previewHint': 'Routes a synthetic request to a WSGI app (e.g. Flask\'s app) in-interpreter — no real socket.',
      'py.previewGo': 'Go',
      'py.previewNoApp': 'No web app detected. Define a WSGI callable named app (e.g. Flask\'s app) and run again.',
      'py.previewPath': 'Path, e.g. /',
    ...
    zh: {
      ...
      'py.previewHint': '在解释器内把一个合成请求路由到 WSGI 应用(例如 Flask 的 app)——并非真实套接字。',
      'py.previewGo': '前往',
      'py.previewNoApp': '未检测到网页应用。请定义一个名为 app 的 WSGI 可调用对象(例如 Flask 的 app)并重新运行。',
      'py.previewPath': '路径,例如 /',
      'py.previewStatus': '状态',
      'py.lastValue': '最后的值',
      'py.figures': '图像',
