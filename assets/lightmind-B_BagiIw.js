const n=`/*
    =========================================================
    lightmind.css  —  山林氛围的 Typora 主题
    正文  : 霞骛文楷 (LXGW WenKai)
    代码  : JetBrains Mono
    基调  : 米黄纸面 · 山林森林绿点缀 · 深海军蓝代码块
    =========================================================
*/
...
:root {
    /* 表面色 */
    --bg-page: #f4f1e8; /* 暖米色 — 纸面 */
    --bg-write: #faf7ef; /* 略亮的写作区背景 */
    --bg-soft: #ece8db; /* 次表面（表格条纹、分隔线）*/
    --bg-formula: #f7f3e8; /* 公式块（对应参考图）*/
    --bg-quote: #ecefe6; /* 雾色草地 */
    --bg-inline-code: #e7eee5; /* 柔和绿色蒙层 */

    /* 文字色 */
    --fg-main: #2c3a32; /* 深森林绿，护眼 */
    --fg-muted: #6b7a6f; /* 次要 / 元信息 */
    --fg-faint: #93a098;
    --fg-heading: #1f2a23; /* 比正文略深 */

    /* 强调色 — 取自风景 */
    --accent: #4a7c59; /* 中山林绿 */
    --accent-deep: #2f5a40; /* 松林阴影 */
    --accent-soft: #8fb39b; /* 雾色山脊 */
    --accent-warm: #c2a878; /* 阳光余晖 */

    /* 代码块底色（取自 JetBrains 截图的深海军蓝）*/
    --code-bg: #1e2330;
    --code-bg-soft: #262c3a;
    --code-fg: #c8cfd9;
    --code-line: #3a4253;
    ...
    --shadow:
        0 2px 10px rgba(44, 58, 50, 0.08), 0 1px 3px rgba(44, 58, 50, 0.05);
    --shadow-lg:
        0 6px 24px rgba(44, 58, 50, 0.12), 0 2px 6px rgba(44, 58, 50, 0.06);
...
#typora-source .CodeMirror-gutters {
    background: var(--bg-write);
    border-right: 1px solid rgba(74, 124, 89, 0.12);
}
...
#write a {
    ...
    border-bottom: 1px solid rgba(74, 124, 89, 0.35);
    transition:
        color 0.15s ease,
...
#write .md-diagram-panel .cluster rect {
    fill: rgba(74, 124, 89, 0.06) !important;
...
#write
    ...
    fill: rgba(74, 124, 89, 0.15) !important;
}
#write
    .md-diagram-panel
    svg[aria-roledescription="packet"]
...
#write
    ...
    fill: rgba(143, 179, 155, 0.2) !important;
}
#write
    .md-diagram-panel
    svg[aria-roledescription="packet"]
...
#write .md-diagram-panel .statediagram-cluster.statediagram-cluster .inner {
    fill: rgba(74, 124, 89, 0.05) !important;
    stroke: var(--accent-soft) !important;
    stroke-width: 1px !important;
}
...
#write .md-diagram-panel .section3 {
    fill: rgba(74, 124, 89, 0.1) !important;
    stroke: none !important;
}
...
#write .md-diagram-panel .grid :is(line, path) {
    stroke: rgba(74, 124, 89, 0.18) !important;
    stroke-width: 1px !important;
}
...
#write blockquote blockquote {
    border-color: rgba(143, 179, 155, 0.35);
...
#write .md-alert {
    ...
    padding: 14px 20px;
    margin: 0.9em 0;
    border: 1px solid var(--alert-border, rgba(74, 124, 89, 0.2));
...
#write .md-alert.md-alert-note {
    --alert-accent: #4a8fc4;
    --alert-bg: #eaf2f9;
    --alert-border: rgba(74, 143, 196, 0.25);
}
#write .md-alert.md-alert-tip {
    --alert-accent: #4a7c59;
    --alert-bg: #ebf2ec;
    --alert-border: rgba(74, 124, 89, 0.28);
}
#write .md-alert.md-alert-important {
    --alert-accent: #8b5fbf;
    --alert-bg: #f0eaf6;
    --alert-border: rgba(139, 95, 191, 0.25);
}
#write .md-alert.md-alert-warning {
    --alert-accent: #c8943a;
    --alert-bg: #f7efde;
    --alert-border: rgba(200, 148, 58, 0.3);
}
#write .md-alert.md-alert-caution {
    --alert-accent: #c4564a;
    --alert-bg: #f6e9e7;
    --alert-border: rgba(196, 86, 74, 0.28);
}
...
#write td {
    padding: 9px 14px;
    border-top: 1px solid rgba(74, 124, 89, 0.38);
...
#write .md-math-block .md-mathblock-input {
    background: rgba(74, 124, 89, 0.14) !important;
    border-radius: 6px !important;
